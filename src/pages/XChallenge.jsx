...
const XChallenge = () => {
  ...
  const [activePlan, setActivePlan] = useState("Profitxaire");
  ...
  useLayoutEffect(() => {
    ...
    const PADDING_X = 6; // 👈 reduced

    setSliderStyle({
      width: tabRect.width + PADDING_X * 2,
      left: Math.max(tabRect.left - wrapperRect.left - PADDING_X, 0),
    });
  }, [activePlan]);
  ...
  return (
    <main className="bg-[#090909] text-white overflow-x-hidden font-['Helvetica_Neue']">
      ...
      >
        ...
        <div>
          <div
            className="inline-flex items-center px-[18px] py-[15px]
          ...
          >
            ...
            <span className="text-[#82F352]">Trader-Friendly</span>
            <br />
          ...
          >
            ...
            best challenge in the industry, the Profitx Funded Profitxaire
            Challenge.
          </p>
...
>
      ...
      <section className="w-full flex justify-center mt-[120px] sm:mt-[160px]">
        <div className="w-full overflow-x-hidden md:overflow-x-auto px-2 sm:px-0">
          <div className="w-full md:min-w-[1239px] flex flex-col items-center">
            {/* TOP CONTROLS */}
  ...
  "
              >
                Difference Between Profitxaire & Profitxaire Lite Challenge
              </h2>
    ...
    "
        ...
        ${activePlan === "lite" ? "text-white" : "text-white/70"}`}
              ...
              <div className="flex items-center gap-4 h-[28px]">
                <span className="font-bold text-[18px] sm:text-[18px] lg:text-[18px]">
                  Select Preference
                </span>
                {[1, 2].map((step) => (
                  <button
      ...
      >
        ...
        >
          <div>
            <h2
              className="text-[32px] sm:text-[48px] lg:text-[55px]
            ...
            <p
              className="mt-4 sm:mt-6 max-w-[520px]
                          text-[14px] sm:text-[17px] text-white/90"
            >
              At Profitx Funded, earn with confidence. If we miss the 24-hour
              payout, we add $1000 extra — guaranteed.
            </p>
          </div>
